...
public class UserDTO implements UserDetails {
    ...
    @NotNull(groups = {ValidationGroups.signup.class, ValidationGroups.signup.class}, message = "이메일은 공백일 수 없습니다.")
    ...
    @Pattern(regexp = "^[a-zA-Z0-9]{6,20}$", groups = {ValidationGroups.signup.class}, message = "아이디는 특수문자와 초성, 한글은 사용불가능합니다")
    protected String id;
